...
object RudderConfig extends Loggable {
  import RudderParsedProperties.builtTimestamp
  import RudderParsedProperties.rudderFullVersion
...
object RudderConfigInit {
  ...
  def init(): RudderServiceApi = {
    ...
    ZioRuntime
      .unsafeRun(
        (
          for {
            _   <- ZIO.foreachPar(List("a", "b", "c", "d"))(c => effectUioUnit(s"****** => ${c}"))
            con <- roLdap
          } yield {
    ...
    lazy val ruleApplicationStatusService: RuleApplicationStatusService = new RuleApplicationStatusServiceImpl()
    lazy val propertyEngineService:        PropertyEngineService        = new PropertyEngineServiceImpl(
      List.empty
    )
    ...
    lazy val ditQueryDataImpl   = new DitQueryData(acceptedNodesDit, nodeDit, rudderDit, getSubGroupChoices)
    ...
    lazy val inventoryMapper: InventoryMapper =
      new InventoryMapper(inventoryDitService, pendingNodesDit, acceptedNodesDit, removedNodesDitImpl)
    ...
    lazy val userPropertyService: UserPropertyService = new StatelessUserPropertyService(
    ...
    lazy val inventoryLogEventServiceImpl = new InventoryEventLogServiceImpl(eventLogRepository)
    ...
    lazy val queryProcessor = new AcceptedNodesLDAPQueryProcessor(
      nodeDit,
      acceptedNodesDit,
      new InternalLDAPQueryProcessor(roLdap, acceptedNodesDit, nodeDit, ditQueryDataImpl, ldapEntityMapper),
      nodeInfoServiceImpl
    )
    ...
    lazy val inventoryQueryChecker = new PendingNodesLDAPQueryChecker(
      new InternalLDAPQueryProcessor(
        ...
        new DitQueryData(pendingNodesDit, nodeDit, rudderDit, () => Nil.succeed),
        ldapEntityMapper
      ),
      nodeInfoServiceImpl
    )
    ...
    lazy val acceptInventory:              UnitAcceptInventory with UnitRefuseInventory =
      new AcceptInventory("accept_new_server:inventory", pendingNodesDit, acceptedNodesDit, fullInventoryRepository)
    ...
    lazy val databaseManagerImpl      = new DatabaseManagerImpl(reportsRepository, updateExpectedRepo)
    lazy val readOnlySoftwareDAO:    ReadOnlySoftwareDAO  =
      new ReadOnlySoftwareDAOImpl(inventoryDitService, roLdap, inventoryMapper)
    lazy val softwareInventoryRWDAO: WriteOnlySoftwareDAO = new WriteOnlySoftwareDAOImpl(acceptedNodesDit, rwLdap)
    lazy val softwareService:        SoftwareService      =
      new SoftwareServiceImpl(readOnlySoftwareDAO, softwareInventoryRWDAO, acceptedNodesDit)
    ...
    lazy val roLdapDirectiveRepository =
      new RoLDAPDirectiveRepository(rudderDit, roLdap, ldapEntityMapper, techniqueRepositoryImpl, uptLibReadWriteMutex)
    ...
    lazy val roLdapRuleRepository =
      new RoLDAPRuleRepository(rudderDit, roLdap, ldapEntityMapper, ruleReadWriteMutex)
    lazy val roRuleRepository: RoRuleRepository = roLdapRuleRepository

    lazy val woRuleRepository: WoRuleRepository = new WoLDAPRuleRepository(
      roLdapRuleRepository,
      rwLdap,
      ldapDiffMapper,
      roLdapNodeGroupRepository,
    ...
    lazy val woNodeRepository: WoNodeRepository = new WoLDAPNodeRepository(
      nodeDit,
      acceptedNodesDit,
      ldapEntityMapper,
      rwLdap,
    ...
    lazy val RoParameterRepository: RoParameterRepository = roLDAPParameterRepository
    ...
    lazy val policyServerManagementService: PolicyServerManagementService = new PolicyServerManagementServiceImpl(
      rwLdap,
      rudderDit,
      eventLogRepository
    )
    ...
    lazy val asyncDeploymentAgent: AsyncDeploymentActor = {
    ...
    lazy val reportsRepository: ReportsRepository = new ReportsJdbcRepository(doobie)
    ...
    lazy val eventLogDeploymentServiceImpl = new EventLogDeploymentService(eventLogRepository, eventLogDetailsServiceImpl)
    ...
    lazy val dependencyAndDeletionService: DependencyAndDeletionService = new DependencyAndDeletionServiceImpl(
      new FindDependenciesImpl(roLdap, rudderDit, ldapEntityMapper),
      roLdapDirectiveRepository,
      woLdapDirectiveRepository,
      woRuleRepository,
    ...
    lazy val logDisplayerImpl:               LogDisplayer               =
      new LogDisplayer(reportsRepository, configurationRepository, roLdapRuleRepository)
    lazy val categoryHierarchyDisplayerImpl: CategoryHierarchyDisplayer = new CategoryHierarchyDisplayer()
    lazy val updateDynamicGroups:            UpdateDynamicGroups        = new UpdateDynamicGroups(
      dynGroupServiceImpl,
      dynGroupUpdaterService,
      asyncDeploymentAgent,
      uuidGen,
   ...
   */
    ...
    lazy val allBootstrapChecks = new SequentialImmediateBootStrapChecks(
      ...
      new CheckDIT(pendingNodesDit, acceptedNodesDit, removedNodesDitImpl, rudderDit, rwLdap),
    ...
    lazy val directiveEditorService: DirectiveEditorService =
    ...
    lazy val debugScript = new DebugInfoServiceImpl
